...
: id3_file_open ( path how -- file ) imm 2 libcall ;
: ID3_FILE_MODE_READONLY 0 ;
"id3_file_tag" "libid3tag.so" resolve
: id3_file_tag ( file -- tag ) imm 1 libcall ;
"id3_tag_findframe" "libid3tag.so" resolve
: id3_tag_findframe ( tag whichframe 0 -- frame ) imm 3 libcall ;
: ID3_FRAME_TITLE "TIT2" ;
: ID3_FRAME_ARTIST "TPE1" ;
"id3_frame_field" "libid3tag.so" resolve
: id3_frame_field ( frame 1 -- field ) imm 2 libcall ;
"id3_field_getstrings" "libid3tag.so" resolve
: id3_field_getstrings ( field 0 -- ucs4 ) imm 2 libcall ;
"id3_ucs4_utf8duplicate" "libid3tag.so" resolve
: id3_ucs4_utf8duplicate ( ucs4 -- utf8 ) imm 1 libcall ;
"printf" "libc.so" resolve
: prints ( str -- ) "%s" swap imm 2 libcall drop ;
